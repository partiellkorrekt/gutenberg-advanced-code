...
ace.define("ace/ext/beautify", [
    ...
    exports1.formatOptions = {
        lineBreaksAfterCommasInCurlyBlock: true
    };
    exports1.beautify = function(session) {
        var iterator = new TokenIterator(session, 0, 0);
        var token = iterator.getCurrentToken();
        var tabString = session.getTabString();
        var singletonTags = exports1.singletonTags;
        var blockTags = exports1.blockTags;
        var formatOptions = exports1.formatOptions || {};
        var nextToken;
    ...
    exports1.commands = [
        {
            ...
            exec: function exec(editor) {
                exports1.beautify(editor.session);
            },
