...
ace.define("ace/ext/menu_tools/overlay_page", [
    ...
    module1.exports.overlayPage = function overlayPage(editor, contentElement, callback) {
...
ace.define("ace/ext/prompt", [
    ...
    function prompt(editor, message, options, callback) {
        if ((typeof message === "undefined" ? "undefined" : _type_of(message)) == "object") {
