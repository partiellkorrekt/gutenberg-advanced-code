...
ace.define("ace/mode/nasal_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    ...
    var NasalHighlightRules = function NasalHighlightRules() {
        this.$rules = {
            start: [
                {
    ...
    exports1.NasalHighlightRules = NasalHighlightRules;
});
