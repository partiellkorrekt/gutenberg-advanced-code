...
ace.define("ace/keyboard/vscode", [
    "require",
    "exports",
    "module",
    ...
    exports1.handler.$id = "ace/keyboard/vscode";
    ...
    [
        ...
        var command = exports1.handler.commands[binding.name];
        if (command) command.bindKey = binding.bindKey;
        exports1.handler.bindKey(binding.bindKey, command || binding.name);
    });
});
(function() {
    ace.require([
