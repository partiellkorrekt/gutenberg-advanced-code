...
ace.define("ace/mode/c_cpp_highlight_rules", [
    ...
    exports1.c_cppHighlightRules = c_cppHighlightRules;
});
...
ace.define("ace/mode/nix_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
        ...
        this.$rules = {
            "start": [
                ...
                },
                {
                    regex: "(==|!=|<=?|>=?)",
                    token: [
                        "keyword.operator.comparison.nix"
                    ]
                },
                {
                    regex: "((?:[+*/%-]|\\~)=)",
                    token: [
                        "keyword.operator.assignment.arithmetic.nix"
                    ]
                },
                {
                    regex: "=",
    ...
    exports1.NixHighlightRules = NixHighlightRules;
});
ace.define("ace/mode/nix", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
