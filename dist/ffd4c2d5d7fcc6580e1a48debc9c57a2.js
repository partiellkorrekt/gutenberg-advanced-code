...
ace.define("ace/mode/assembly_arm32_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    ...
    var AssemblyARM32HighlightRules = function AssemblyARM32HighlightRules() {
        this.$rules = {
            start: [
                {
    ...
    exports1.AssemblyARM32HighlightRules = AssemblyARM32HighlightRules;
});
...
ace.define("ace/mode/assembly_arm32", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
