...
ace.define("ace/mode/elixir_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    ...
    exports1.ElixirHighlightRules = ElixirHighlightRules;
});
ace.define("ace/mode/html_elixir_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    ...
    var HtmlElixirHighlightRules = function HtmlElixirHighlightRules() {
        ...
        this.embedRules(ElixirHighlightRules, "elixir-", endRules, [
            "start"
        ]);
        this.normalizeRules();
    };
    oop.inherits(HtmlElixirHighlightRules, HtmlHighlightRules);
    exports1.HtmlElixirHighlightRules = HtmlElixirHighlightRules;
});
...
ace.define("ace/mode/html_elixir", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
