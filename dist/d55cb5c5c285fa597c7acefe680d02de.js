...
ace.define("ace/mode/slim_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/config",
    ...
    exports1.SlimHighlightRules = SlimHighlightRules;
});
ace.define("ace/mode/jsdoc_comment_highlight_rules", [
    ...
    var oop = require("../lib/oop");
    var TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;
    var JsDocCommentHighlightRules = function JsDocCommentHighlightRules1() {
        this.$rules = {
            "start": [
                {
                    token: [
    ...
    exports1.JsDocCommentHighlightRules = JsDocCommentHighlightRules;
});
ace.define("ace/mode/javascript_highlight_rules", [
    ...
    exports1.JavaScriptHighlightRules = JavaScriptHighlightRules;
});
ace.define("ace/mode/matching_brace_outdent", [
    ...
    exports1.MatchingBraceOutdent = MatchingBraceOutdent;
});
ace.define("ace/mode/behaviour/xml", [
    ...
    exports1.XmlBehaviour = XmlBehaviour;
});
ace.define("ace/mode/behaviour/javascript", [
    ...
    var JavaScriptBehaviour = function JavaScriptBehaviour() {
    ...
    exports1.JavaScriptBehaviour = JavaScriptBehaviour;
});
ace.define("ace/mode/folding/xml", [
    ...
    var FoldMode = exports1.FoldMode = function FoldMode(voidElements, optionalEndTags) {
...
ace.define("ace/mode/folding/cstyle", [
    ...
    var Range = require("../../range").Range;
    var BaseFoldMode = require("./fold_mode").FoldMode;
    var FoldMode = exports1.FoldMode = function FoldMode(commentRegex) {
        if (commentRegex) {
...
ace.define("ace/mode/css_highlight_rules", [
    ...
    exports1.CssHighlightRules = CssHighlightRules;
});
ace.define("ace/mode/xml_highlight_rules", [
    ...
    var oop = require("../lib/oop");
    var TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;
    var XmlHighlightRules = function XmlHighlightRules1(normalize) {
    ...
    exports1.XmlHighlightRules = XmlHighlightRules;
});
ace.define("ace/mode/html_highlight_rules", [
    ...
    var HtmlHighlightRules = function HtmlHighlightRules1() {
    ...
    exports1.HtmlHighlightRules = HtmlHighlightRules;
});
ace.define("ace/mode/markdown_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/config",
    ...
    exports1.MarkdownHighlightRules = MarkdownHighlightRules;
});
ace.define("ace/mode/folding/markdown", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
...
ace.define("ace/mode/css_completions", [
    ...
    (function() {
        ...
        this.getPropertyValueCompletions = function(state, session, pos, prefix) {
            ...
            if (!property) return [];
            var values = [];
            if (property in propertyMap && _type_of(propertyMap[property]) === "object") {
    ...
    exports1.CssCompletions = CssCompletions;
});
ace.define("ace/mode/behaviour/css", [
    ...
    exports1.CssBehaviour = CssBehaviour;
});
...
ace.define("ace/mode/folding/mixed", [
    ...
    var oop = require("../../lib/oop");
    var BaseFoldMode = require("./fold_mode").FoldMode;
    var FoldMode = exports1.FoldMode = function FoldMode(defaultMode, subModes) {
...
ace.define("ace/mode/folding/html", [
    ...
    var FoldMode = exports1.FoldMode = function FoldMode(voidElements, optionalTags) {
...
ace.define("ace/mode/html_completions", [
    ...
    (function() {
        ...
        this.getAttributeValueCompletions = function(state, session, pos, prefix) {
            ...
            if (!tagName) return [];
            var values = [];
            if (tagName in attributeMap && attributeName in attributeMap[tagName] && _type_of(attributeMap[tagName][attributeName]) === "object") {
    ...
    exports1.HtmlCompletions = HtmlCompletions;
});
...
ace.define("ace/mode/sh_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    ...
    var oop = require("../lib/oop");
    var TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;
    var reservedKeywords = exports1.reservedKeywords = '!|{|}|case|do|done|elif|else|' + 'esac|fi|for|if|in|then|until|while|' + '&|;|export|local|read|typeset|unset|' + 'elif|select|set|function|declare|readonly';
    var languageConstructs = exports1.languageConstructs = '[|]|alias|bg|bind|break|builtin|' + 'cd|command|compgen|complete|continue|' + 'dirs|disown|echo|enable|eval|exec|' + 'exit|fc|fg|getopts|hash|help|history|' + 'jobs|kill|let|logout|popd|printf|pushd|' + 'pwd|return|set|shift|shopt|source|' + 'suspend|test|times|trap|type|ulimit|' + 'umask|unalias|wait';
    ...
    exports1.ShHighlightRules = ShHighlightRules;
});
ace.define("ace/mode/sh", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
...
ace.define("ace/mode/coffee_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    ...
    exports1.CoffeeHighlightRules = CoffeeHighlightRules;
});
...
ace.define("ace/mode/scss_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    ...
    exports1.ScssHighlightRules = ScssHighlightRules;
});
ace.define("ace/mode/scss", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
...
ace.define("ace/mode/sass_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    ...
    exports1.SassHighlightRules = SassHighlightRules;
});
ace.define("ace/mode/sass", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
...
ace.define("ace/mode/less_highlight_rules", [
    ...
    exports1.LessHighlightRules = LessHighlightRules;
});
ace.define("ace/mode/less", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
...
ace.define("ace/mode/ruby_highlight_rules", [
    ...
    var oop = require("../lib/oop");
    var TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;
    var constantOtherSymbol = exports1.constantOtherSymbol = {
    ...
    var constantNumericHex = exports1.constantNumericHex = {
        token: "constant.numeric",
        regex: "0[xX][0-9a-fA-F](?:[0-9a-fA-F]|_(?=[0-9a-fA-F]))*\\b"
    };
    var constantNumericBinary = exports1.constantNumericBinary = {
        token: "constant.numeric",
        regex: /\b(0[bB][01](?:[01]|_(?=[01]))*)\b/
    };
    var constantNumericDecimal = exports1.constantNumericDecimal = {
        token: "constant.numeric",
        regex: /\b(0[dD](?:[1-9](?:[\d]|_(?=[\d]))*|0))\b/
    };
    var constantNumericOctal = exports1.constantNumericOctal = {
        token: "constant.numeric",
        regex: /\b(0[oO]?(?:[1-7](?:[0-7]|_(?=[0-7]))*|0))\b/
    };
    var constantNumericRational = exports1.constantNumericRational = {
        token: "constant.numeric",
        regex: /\b([\d]+(?:[./][\d]+)?ri?)\b/
    };
    var constantNumericComplex = exports1.constantNumericComplex = {
        token: "constant.numeric",
        regex: /\b([\d]i)\b/
    };
    var constantNumericFloat = exports1.constantNumericFloat = {
        token: "constant.numeric",
        regex: "[+-]?\\d(?:\\d|_(?=\\d))*(?:(?:\\.\\d(?:\\d|_(?=\\d))*)?(?:[eE][+-]?\\d+)?)?i?\\b"
    };
    var instanceVariable = exports1.instanceVariable = {
    ...
    exports1.RubyHighlightRules = RubyHighlightRules;
});
