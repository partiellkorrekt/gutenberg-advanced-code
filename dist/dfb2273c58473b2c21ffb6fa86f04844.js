...
ace.define("ace/snippets", [
    ...
    var SnippetManager = /** @class */ function() {
                ...
                formatString: [
                    ...
                    },
                    {
                        ...
                        onMatch: function onMatch(val, state, stack) {
                            ...
                            else if ("ulULE".indexOf(ch) != -1) val = {
                                changeCase: ch,
                                local: ch > "a"
                            };
                            return [
        ...
        SnippetManager.prototype.tmStrFormat = function(str, ch, editor) {
            ...
            var formatted = str.replace(re, function() {
                ...
                for(var i = 0; i < fmtParts.length; i++){
                    var _$ch = fmtParts[i];
                    if ((typeof _$ch === "undefined" ? "undefined" : _type_of(_$ch)) == "object") {
                        fmtParts[i] = "";
                        if (_$ch.changeCase && _$ch.local) {
                            var next = fmtParts[i + 1];
                            if (next && typeof next == "string") {
                                if (_$ch.changeCase == "u") fmtParts[i] = next[0].toUpperCase();
                                else fmtParts[i] = next[0].toLowerCase();
                                fmtParts[i + 1] = next.substr(1);
                            }
                        } else if (_$ch.changeCase) {
                            gChangeCase = _$ch.changeCase;
                        }
                    } else if (gChangeCase == "U") {
                        fmtParts[i] = _$ch.toUpperCase();
                    } else if (gChangeCase == "L") {
                        fmtParts[i] = _$ch.toLowerCase();
                    }
                }
        ...
        SnippetManager.prototype.$getScope = function(editor) {
            ...
            if (scope === "html" || scope === "php") {
                ...
                if ((typeof state === "undefined" ? "undefined" : _type_of(state)) === "object") {
                    state = state[0];
                }
                if (state.substring) {
    ...
    var processSnippetText = function processSnippetText(editor, snippetText, options) {
        ...
        tokens.forEach(function(p, i) {
            if ((typeof p === "undefined" ? "undefined" : _type_of(p)) != "object") return;
            var id = p.tabstopId;
            var ts = tabstops[id];
            if (!ts) {
                ts = tabstops[id] = [];
            ...
            var isNested = value.some(function(t) {
                return (typeof t === "undefined" ? "undefined" : _type_of(t)) === "object";
            });
        ...
        function copyValue(val) {
            ...
            for(var i = 0; i < val.length; i++){
                var p = val[i];
                if ((typeof p === "undefined" ? "undefined" : _type_of(p)) == "object") {
        ...
        for(var i = 0; i < tokens.length; i++){
            var p = tokens[i];
            if ((typeof p === "undefined" ? "undefined" : _type_of(p)) != "object") continue;
            var id = p.tabstopId;
            var ts = tabstops[id];
            var i1 = tokens.indexOf(p, i + 1);
            if (expanding[id]) {
    ...
    var TabstopManager = /** @class */ function() {
        ...
        TabstopManager.prototype.updateLinkedFields = function() {
            ...
            for(var i = 0; i < ts.length; i++){
                ...
                var fmt = exports1.snippetManager.tmStrFormat(text, original, this.editor);
    ...
    TabstopManager.prototype.keyboardHandler.bindKeys({
        "Tab": function(editor) {
            if (exports1.snippetManager && exports1.snippetManager.expandWithTab(editor)) return;
    ...
    exports1.snippetManager = new SnippetManager();
    var Editor = require("./editor").Editor;
    (function() {
        this.insertSnippet = function(content, options) {
            return exports1.snippetManager.insertSnippet(this, content, options);
        };
        this.expandSnippet = function(options) {
            return exports1.snippetManager.expandWithTab(this, options);
        };
...
ace.define("ace/autocomplete/inline_screenreader", [
    ...
    exports1.AceInlineScreenReader = AceInlineScreenReader;
});
...
ace.define("ace/autocomplete/popup", [
    ...
    exports1.AcePopup = AcePopup;
    exports1.$singleLineEditor = $singleLineEditor;
    exports1.getAriaId = getAriaId;
});
ace.define("ace/autocomplete/util", [
    ...
    "use strict";
    exports1.parForEach = function(array, fn, callback) {
        var completed = 0;
    ...
    exports1.retrievePrecedingIdentifier = function(text, pos, regex) {
    ...
    exports1.retrieveFollowingIdentifier = function(text, pos, regex) {
        regex = regex || ID_REGEX;
        var buf = [];
    ...
    exports1.getCompletionPrefix = function(editor) {
    ...
    exports1.triggerAutocomplete = function(editor, previousChar) {
...
ace.define("ace/autocomplete", [
    ...
    Autocomplete.for = function(editor) {
        if (_instanceof(editor.completer, Autocomplete)) {
    ...
    exports1.Autocomplete = Autocomplete;
    exports1.CompletionProvider = CompletionProvider;
    exports1.FilteredList = FilteredList;
});
ace.define("ace/ext/command_bar", [
    "require",
    "exports",
    "module",
    "ace/tooltip",
    ...
    var minPosition = function minPosition(posA, posB) {
    ...
    var CommandBarTooltip = /** @class */ function() {
        ...
        CommandBarTooltip.prototype.$createCommand = function(id, command, forMainTooltip) {
            ...
            if (bindKey) {
                if ((typeof bindKey === "undefined" ? "undefined" : _type_of(bindKey)) === 'object') {
    ...
    exports1.CommandBarTooltip = CommandBarTooltip;
    exports1.TOOLTIP_CLASS_NAME = TOOLTIP_CLASS_NAME;
    exports1.BUTTON_CLASS_NAME = BUTTON_CLASS_NAME;
});
ace.define("ace/autocomplete/text_completer", [
    ...
    exports1.getCompletions = function(editor, session, pos, prefix, callback) {
...
ace.define("ace/ext/language_tools", [
    ...
    exports1.setCompleters = function(val) {
        completers.length = 0;
        if (val) completers.push.apply(completers, val);
    };
    exports1.addCompleter = function(completer) {
        completers.push(completer);
    };
    exports1.textCompleter = textCompleter;
    exports1.keyWordCompleter = keyWordCompleter;
    exports1.snippetCompleter = snippetCompleter;
    var expandSnippet = {
        name: "expandSnippet",
    ...
    var loadSnippetsForMode = function loadSnippetsForMode1(mode) {
...
ace.define("ace/ext/inline_autocomplete", [
    "require",
    "exports",
    "module",
    "ace/keyboard/hash_handler",
    ...
    InlineAutocomplete.for = function(editor) {
        if (_instanceof(editor.completer, InlineAutocomplete)) {
            return editor.completer;
        }
        if (editor.completer) {
            editor.completer.destroy();
    ...
    InlineAutocomplete.createInlineTooltip = function(parentEl) {
        ...
        inlineTooltip.registerCommand("Position", {
            enabled: false,
            getValue: function getValue(editor) {
                return editor ? [
        ...
        inlineTooltip.registerCommand("Accept", Object.assign({}, InlineAutocomplete.prototype.commands["Accept"], {
            enabled: function enabled(editor) {
    ...
    exports1.InlineAutocomplete = InlineAutocomplete;
});
(function() {
    ace.require([
