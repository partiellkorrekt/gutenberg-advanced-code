...
ace.define("ace/ext/textarea", [
    ...
    var _$ace = require("../ace");
    module1.exports = exports1 = _$ace;
    ...
    exports1.transformTextarea = function(element, options) {
        ...
        options = options || exports1.defaultOptions;
        var editor = _$ace.edit(editorDiv);
        session = editor.getSession();
        session.setValue(element.value || element.innerHTML);
        if (isFocused) editor.focus();
        container.appendChild(settingOpener);
        setupApi(editor, editorDiv, settingDiv, _$ace, options);
    ...
    function setupApi(editor, editorDiv, settingDiv, ace1, options) {
    ...
    function setupSettingPanel(settingDiv, settingOpener, editor) {
        ...
        for(var option in exports1.defaultOptions){
