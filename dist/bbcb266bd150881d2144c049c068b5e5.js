...
ace.define("ace/mode/json_highlight_rules", [
    ...
    exports1.JsonHighlightRules = JsonHighlightRules;
});
ace.define("ace/mode/json", [
    ...
    (function() {
        ...
        this.createWorker = function(session) {
            var worker = new WorkerClient([
                "ace"
            ], "ace/mode/json_worker", "JsonWorker");
            worker.attachToDocument(session.getDocument());
            worker.on("annotate", function(e) {
                session.setAnnotations(e.data);
            });
...
ace.define("ace/mode/liquid_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    ...
    exports1.LiquidHighlightRules = LiquidHighlightRules;
});
ace.define("ace/mode/liquid", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
