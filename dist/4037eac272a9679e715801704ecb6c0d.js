...
ace.define("ace/mode/zig_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    ...
    var ZigHighlightRules = function ZigHighlightRules() {
        this.$rules = {
            start: [
                {
                    include: "#dummy_main"
    ...
    exports1.ZigHighlightRules = ZigHighlightRules;
});
