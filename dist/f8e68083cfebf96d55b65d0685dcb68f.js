...
ace.define("ace/ext/code_lens", [
    ...
    exports1.setLenses = function(session, lenses) {
    ...
    function attachToEditor(editor) {
        ...
        editor.$updateLenses = function() {
            ...
            function applyLenses() {
                ...
                var firstRow = exports1.setLenses(session, lenses);
    ...
    exports1.registerCodeLensProvider = function(editor, codeLensProvider) {
        editor.setOption("enableCodeLens", true);
        editor.codeLensProviders.push(codeLensProvider);
        editor.$updateLensesOnInput();
    };
    exports1.clear = function(session) {
        exports1.setLenses(session, null);
    };
