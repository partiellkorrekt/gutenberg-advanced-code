...
ace.define("ace/mode/mask_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    ...
    "use strict";
    exports1.MaskHighlightRules = MaskHighlightRules;
    var oop = require("../lib/oop");
    var lang = require("../lib/lang");
    ...
    function MaskHighlightRules() {
        ...
        function addJavaScript(name, escape, closeType) {
            var prfx = "js-" + name + "-", rootTokens = name === "block" ? [
                "start"
            ] : [
                "start",
                "no_regex"
        ...
        function add(Rules, strPrfx, rgxEnd, rootTokens, closeType) {
            ...
            rules.embedRules(Rules, strPrfx, [
                Token(closeType || token_RPARE, rgxEnd, next)
            ], tokens, tokens == null ? true : false);
        }
        this.normalizeRules();
    }
