...
sql_regcase'.split('|'));
    ...
    var PhpHighlightRules = function PhpHighlightRules() {
        ...
        this.embedRules(PhpLangHighlightRules, "php-", endRules, [
            "start"
        ]);
        this.normalizeRules();
    };
    oop.inherits(PhpHighlightRules, HtmlHighlightRules);
    exports1.PhpHighlightRules = PhpHighlightRules;
    exports1.PhpLangHighlightRules = PhpLangHighlightRules;
});
ace.define("ace/mode/php_laravel_blade_highlight_rules", [
    ...
    exports1.PHPLaravelBladeHighlightRules = PHPLaravelBladeHighlightRules;
});
...
ace.define("ace/mode/php_completions", [
    ...
    exports1.PhpCompletions = PhpCompletions;
});
...
ace.define("ace/mode/folding/php", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
