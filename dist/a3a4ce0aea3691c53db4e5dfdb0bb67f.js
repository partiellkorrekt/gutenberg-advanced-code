...
!function(window1) {
    if (typeof window1.window != "undefined" && window1.document) return;
    if (window1.require && window1.define) return;
    if (!window1.console) {
        window1.console = function() {
        ...
        window1.console.error = window1.console.warn = window1.console.log = window1.console.trace = window1.console;
    }
    window1.window = window1;
    window1.ace = window1;
    window1.onerror = function(message, file, line, col, err) {
        postMessage({
            type: "error",
            data: {
                message: message,
    ...
    window1.normalizeModule = function(parentId, moduleName) {
        // normalize plugin requires
        if (moduleName.indexOf("!") !== -1) {
            var chunks = moduleName.split("!");
            return window1.normalizeModule(parentId, chunks[0]) + "!" + window1.normalizeModule(parentId, chunks[1]);
        }
    ...
    window1.require = function require(parentId, id) {
        if (!id) {
            id = parentId;
            parentId = null;
        }
        if (!id.charAt) throw new Error("worker.js require() accepts only (parentId, id) as arguments");
        id = window1.normalizeModule(parentId, id);
        var module = window1.require.modules[id];
        if (module) {
        ...
        if (!window1.require.tlns) return console.log("unable to load " + id);
        var path = resolveModuleId(id, window1.require.tlns);
        if (path.slice(-3) != ".js") path += ".js";
        window1.require.id = id;
        window1.require.modules[id] = {}; // prevent infinite loop on broken modules
        importScripts(path);
        return window1.require(parentId, id);
    };
    ...
    window1.require.modules = {};
    window1.require.tlns = {};
    window1.define = function(id, deps, factory) {
        if (arguments.length == 2) {
            factory = deps;
            if (typeof id != "string") {
                deps = id;
                id = window1.require.id;
            }
        ...
        var req = function req(childId) {
            return window1.require(id, childId);
        };
        window1.require.modules[id] = {
            exports: {},
            factory: function factory1() {
                var module = this;
    ...
    window1.define.amd = {};
    window1.require.tlns = {};
    window1.initBaseUrls = function initBaseUrls(topLevelNamespaces) {
        for(var i in topLevelNamespaces)this.require.tlns[i] = topLevelNamespaces[i];
    };
    window1.initSender = function initSender() {
        var EventEmitter = window1.require("ace/lib/event_emitter").EventEmitter;
        var oop = window1.require("ace/lib/oop");
    ...
    var main = window1.main = null;
    var sender = window1.sender = null;
    window1.onmessage = function(e) {
        var msg = e.data;
        if (msg.event && sender) {
            sender._signal(msg.event, msg.data);
        } else if (msg.command) {
            if (main[msg.command]) main[msg.command].apply(main, msg.args);
            else if (window1[msg.command]) window1[msg.command].apply(window1, msg.args);
            else throw new Error("Unknown command:" + msg.command);
        } else if (msg.init) {
            window1.initBaseUrls(msg.tlns);
            sender = window1.sender = window1.initSender();
            var clazz = this.require(msg.module)[msg.classname];
            main = window1.main = new clazz(sender);
        }
    };
}(this);
...
ace.define("ace/lib/deep_copy", [], function(require, exports, module) {
    exports.deepCopy = function deepCopy(obj) {
        if ((typeof obj === "undefined" ? "undefined" : _type_of(obj)) !== "object" || !obj) return obj;
        var copy;
...
ace.define("ace/lib/lang", [], function(require, exports, module) {
    ...
    exports.copyArray = function(array) {
        ...
        for(var i = 0, l = array.length; i < l; i++){
            if (array[i] && _type_of(array[i]) == "object") copy[i] = this.copyObject(array[i]);
            else copy[i] = array[i];
        }
        return copy;
    };
...
ace.define("ace/lib/event_emitter", [], function(require, exports, module) {
    ...
    EventEmitter._emit = EventEmitter._dispatchEvent = function(eventName, e) {
        ...
        if ((typeof e === "undefined" ? "undefined" : _type_of(e)) != "object" || !e) e = {};
...
ace.define("ace/range", [], function(require, exports, module) {
    ...
    var Range = /** @class */ function() {
        ...
        Range.prototype.setStart = function(row, column) {
            if ((typeof row === "undefined" ? "undefined" : _type_of(row)) == "object") {
...
ace.define("ace/worker/mirror", [], function(require, exports, module) {
    ...
    var Mirror = exports.Mirror = function Mirror(sender) {
        this.sender = sender;
    ...
    module.exports = (function e(t, n, r) {
                ...
                Tokenizer.prototype.tokenize = function(source) {
                    ...
                    function script_data_double_escape_start_state(buffer) {
                        ...
                        if (isWhitespace(data) || data === '/' || data === '>') {
                            ...
                            if (this._temporaryBuffer.toLowerCase() === 'script') tokenizer.setState(script_data_double_escaped_state);
                    ...
                    function character_reference_in_attribute_value_state(buffer) {
                        ...
                        else if (this._additionalAllowedCharacter === '\'') tokenizer.setState(attribute_value_single_quoted_state);
                ...
                function TreeBuilder() {
                    ...
                    modes.inForeignContent.processStartTag = function(name, attributes, selfClosing) {
                        if ([
                            ...
                            'ul',
                            'var'
                        ].indexOf(name) != -1 || name == 'font' && attributes.some(function(attr) {
                            return [
                                'color',
                                'face',
                                'size'
                            ].indexOf(attr.nodeName) >= 0;
                        })) {
                ...
                TreeBuilder.prototype.resetInsertionMode = function() {
                    ...
                    for(var i = this.openElements.length - 1; i >= 0; i--){
                        ...
                        if (node.namespaceURI === "http://www.w3.org/1999/xhtml") {
                            ...
                            if (node.localName === 'html') if (!this.openElements.headElement) return this.setInsertionMode('beforeHead');
        ...
        10: [
            function(_dereq_, module, exports) {
                ...
                function Element(locator, uri, localName, qName, atts, prefixMappings1) {
                    ParentNode.call(this, locator);
                    this.uri = uri;
                    this.localName = localName;
                    this.qName = qName;
                    this.attributes = atts;
                    this.prefixMappings = prefixMappings1;
        ...
        13: [
            function(_dereq_, module, exports) {
                ...
                function getMessage(self1) {
                    return truncate(JSON.stringify(self1.actual, replacer), 128) + ' ' + self1.operator + ' ' + truncate(JSON.stringify(self1.expected, replacer), 128);
                }
                ...
                function expectedException(actual, expected) {
                    ...
                    } else if (_instanceof(actual, expected)) {
                        return true;
        ...
        14: [
            function(_dereq_, module, exports) {
                module.exports = function isBuffer(arg) {
                    return arg && (typeof arg === "undefined" ? "undefined" : _type_of(arg)) === 'object' && typeof arg.copy === 'function' && typeof arg.fill === 'function' && typeof arg.readUInt8 === 'function';
                };
            },
            {}
        ],
...
ace.define("ace/mode/html_worker", [], function(require, exports, module) {
    ...
    var Worker = exports.Worker = function Worker(sender) {
