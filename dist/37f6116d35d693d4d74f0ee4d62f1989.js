...
ace.define("ace/ext/spellcheck", [
    ...
    exports1.contextMenuHandler = function(e) {
        var host = e.target;
    ...
    require("../config").defineOptions(Editor.prototype, "editor", {
        spellcheck: {
            set: function set(val) {
                ...
                text.spellcheck = !!val;
                if (!val) this.removeListener("nativecontextmenu", exports1.contextMenuHandler);
                else this.on("nativecontextmenu", exports1.contextMenuHandler);
            },
            value: true
        }
    });
