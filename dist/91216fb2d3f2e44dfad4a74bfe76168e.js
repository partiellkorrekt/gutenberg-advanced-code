...
ace.define("ace/ext/hardwrap", [
    ...
    exports1.hardWrap = hardWrap;
});
ace.define("ace/keyboard/vim", [
    "require",
    "exports",
    "module",
    "ace/range",
    ...
    function log() {
        var d = "";
        function format(p) {
            if ((typeof p === "undefined" ? "undefined" : _type_of(p)) != "object") return p + "";
            if ("line" in p) {
                return p.line + ":" + p.ch;
            }
            if ("anchor" in p) {
    ...
    var CodeMirror = function CodeMirror(ace1) {
        this.ace = ace1;
        this.state = {};
        this.marks = {};
        this.options = {};
    ...
    CodeMirror.Pos = function(line, ch) {
        if (!_instanceof(this, Pos)) return new Pos(line, ch);
        this.line = line;
        this.ch = ch;
    };
    ...
    (function() {
        ...
        this.setCursor = function(line, ch) {
            if ((typeof line === "undefined" ? "undefined" : _type_of(line)) === 'object') {
                ch = line.ch;
                line = line.line;
            }
        ...
        this.getSearchCursor = function(query, pos, caseFold) {
            ...
            var isRegexp = false;
            if (_instanceof(query, RegExp) && !query.global) {
    ...
    var StringStream = CodeMirror.StringStream = function StringStream(string, tabSize) {
    ...
    defineOption('textwidth', 80, 'number', [
        'tw'
    ], function(width, cm) {
        if (cm === undefined) {
            return;
    ...
    function sendKeyToPrompt(key) {
        ...
        if (key == '\n') {
            var prompt1 = virtualPrompt;
            virtualPrompt = null;
            prompt1.onClose && prompt1.onClose(prompt1.value);
        } else {
    ...
    defineOption('langmap', undefined, 'string', [
        'lmap'
    ], function(name, cm) {
        if (name === undefined) {
    ...
    var commandDispatcher = {
        ...
        evalInput: function evalInput(cm, vim) {
            ...
            if (motion) {
                ...
                if (_instanceof(motionResult, Array)) {
    ...
    var motions = {
        ...
        findNext: function findNext1(cm, _head, motionArgs) {
        ...
        moveTillCharacter: function moveTillCharacter(cm, head, motionArgs) {
            var repeat = motionArgs.repeat;
        ...
        moveToCharacter: function moveToCharacter1(cm, head, motionArgs) {
            var repeat = motionArgs.repeat;
        ...
        moveToColumn: function moveToColumn1(cm, head, motionArgs, vim) {
            var repeat = motionArgs.repeat;
            vim.lastHPos = repeat - 1;
            vim.lastHSPos = cm.charCoords(head, 'div').left;
            return moveToColumn(cm, repeat);
        },
        moveToEol: function moveToEol1(cm, head, motionArgs, vim) {
    ...
    var operators = {
        ...
        hardWrap: function hardWrap(cm, operatorArgs, ranges, oldAnchor, newHead) {
    ...
    var actions = {
        ...
        insertRegister: function insertRegister(cm, actionArgs, vim) {
            var registerName = actionArgs.selectedCharacter;
            var register = vimGlobalState.registerController.getRegister(registerName);
        ...
        oneNormalCommand: function oneNormalCommand(cm, actionArgs, vim) {
        ...
        repeatLastEdit: function repeatLastEdit1(cm, actionArgs, vim) {
    ...
    function offsetCursor(cur, offsetLine, offsetCh) {
        if ((typeof offsetLine === "undefined" ? "undefined" : _type_of(offsetLine)) === 'object') {
    ...
    function dom(n) {
        ...
        for(var a, i = 1; i < arguments.length; i++){
            ...
            if ((typeof a === "undefined" ? "undefined" : _type_of(a)) !== 'object') a = document.createTextNode(a);
    ...
    function regexEqual(r1, r2) {
        if (_instanceof(r1, RegExp) && _instanceof(r2, RegExp)) {
            var props = [
                'global',
                'multiline',
                'ignoreCase',
    ...
    ExCommandDispatcher.prototype = {
        ...
        map: function map(lhs, rhs, ctx, noremap) {
            if (lhs != ':' && lhs.charAt(0) == ':') {
                if (ctx) {
    ...
    var exCommands = {
        ...
        map: function map(cm, params, ctx, defaultOnly) {
        ...
        omap: function omap(cm, params) {
            this.map(cm, params, 'operatorPending');
        },
        noremap: function noremap(cm, params) {
            this.map(cm, params, undefined, true);
        },
        inoremap: function inoremap(cm, params) {
            this.map(cm, params, 'insert', true);
        },
        nnoremap: function nnoremap(cm, params) {
            this.map(cm, params, 'normal', true);
        },
        vnoremap: function vnoremap(cm, params) {
            this.map(cm, params, 'visual', true);
        },
        onoremap: function onoremap(cm, params) {
        ...
        mapclear: function mapclear(cm, params) {
            vimApi.mapclear();
        },
        imapclear: function imapclear(cm, params) {
            vimApi.mapclear('insert');
        },
        nmapclear: function nmapclear(cm, params) {
            vimApi.mapclear('normal');
        },
        vmapclear: function vmapclear(cm, params) {
            vimApi.mapclear('visual');
        },
        omapclear: function omapclear(cm, params) {
        ...
        set: function set(cm, params) {
            ...
            if (!optionIsBoolean && value === undefined || forceGet) {
                ...
                if (_instanceof(setOptionReturn, Error)) {
        ...
        normal: function normal(cm, params) {
        ...
        global: function global(cm, params) {
            ...
            var index = 0;
            var nextCommand = function nextCommand1() {
        ...
        startinsert: function startinsert(cm, params) {
        ...
        delete: function _delete(cm, params) {
    ...
    function repeatInsertModeChanges(cm, changes, repeat) {
        ...
        for(var i = 0; i < repeat; i++){
            ...
            for(var j = 0; j < changes.length; j++){
                ...
                if (_instanceof(change, InsertModeKey)) {
    ...
    function cloneVimState(state) {
        ...
        Object.keys(state).forEach(function(key) {
            ...
            else if (o && (typeof o === "undefined" ? "undefined" : _type_of(o)) == "object" && o.constructor != Object) o = cloneVimState(o);
            n[key] = o;
        });
        if (state.sel) {
            n.sel = {
    ...
    resetVimGlobalState();
    exports1.CodeMirror = CodeMirror;
    ...
    defineOption('textwidth', undefined, 'number', [
        'tw'
    ], function(width, cm) {
        if (cm === undefined) {
            return;
    ...
    function delayedExecAceCommand(op, ace1) {
        ace1.off("beforeEndOperation", delayedExecAceCommand);
        var cmd = ace1.state.cm.vimCmd;
        if (cmd) {
            ace1.execCommand(cmd.exec ? cmd : cmd.name, cmd.args);
        }
        ace1.curOp = ace1.prevOp;
    }
    ...
    exports1.handler.defaultKeymap = defaultKeymap;
    exports1.handler.actions = actions;
    exports1.Vim = vimApi;
});
(function() {
    ace.require([
