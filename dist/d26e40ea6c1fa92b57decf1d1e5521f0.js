    ...
    (function(root, name, factory) {
        ...
        function parseForStatement(flowContext) {
            ...
            if (consume('=')) {
                ...
                expect(',');
                var _$end = parseExpectedExpression(flowContext);
                ...
                expect('end');
                if (options.scope) destroyScope();
                return finishNode(ast.forNumericStatement(variable, start, _$end, step, body));
            } else {
                var variables = [
                    variable
                ];
        ...
        function parse(_input, _options) {
            if ('undefined' === typeof _options && 'object' === (typeof _input === "undefined" ? "undefined" : _type_of(_input))) {
                _options = _input;
                _input = undefined;
            }
    ...
    (function() {
        this.onUpdate = function() {
            ...
            try {
                ...
                if (_instanceof(e, luaparse.SyntaxError)) {
                    errors.push({
                        row: e.line - 1,
                        column: e.column,
                        text: e.message,
