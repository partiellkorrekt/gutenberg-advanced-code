...
ace.define("ace/mode/ftl_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    ...
    var FtlHighlightRules = function FtlHighlightRules() {
        ...
        this.embedRules(FtlLangHighlightRules, "ftl-", endRules, [
            "start"
        ]);
        this.addRules({
            "ftl-dcomment": [
    ...
    exports1.FtlHighlightRules = FtlHighlightRules;
});
ace.define("ace/mode/ftl", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
