...
ace.define("ace/lib/lang", [], function(require, exports, module) {
    ...
    exports.arrayRemove = function(array, value1) {
...
ace.define("ace/worker/mirror", [], function(require, exports, module) {
    ...
    (function() {
        ...
        this.setValue = function(value1) {
            this.doc.setValue(value1);
...
ace.define("ace/mode/xml/sax", [], function(require, exports, module) {
            ...
            switch(c){
                ...
                case '"':
                    if (s === S_EQ) {
                        ...
                        if (p > 0) {
                            value1 = source.slice(start, p).replace(/&#?\w+;/g, entityReplacer);
                            el.add(attrName, value1, start - 1);
                            s = S_E;
                        } else {
                    ...
                    switch(s){
                        ...
                        case S_ATTR_S:
                            ...
                            if (s == S_V) {
                                ...
                                el.add(attrName, value1.replace(/&#?\w+;/g, entityReplacer), start);
                            } else {
                                errorHandler.warning('attribute "' + value1 + '" missed value!! "' + value1 + '" instead!!');
                                el.add(value1, value1, start);
                            }
                            break;
                        case S_EQ:
    ...
    function appendElement(el, domBuilder, parseStack, errorHandler) {
        ...
        while(i--){
            ...
            if (nsPrefix !== false) {
                ...
                currentNSMap[nsPrefix] = localNSMap[nsPrefix] = value1;
                a.uri = 'http://www.w3.org/2000/xmlns/';
                domBuilder.startPrefixMapping(nsPrefix, value1);
            }
        }
        var i = el.length;
        while(i--){
    ...
    ElementAttributes.prototype = {
        ...
        add: function add(qName, value1, offset) {
    ...
    if (!_instanceof(_set_proto_({}, _set_proto_.prototype), _set_proto_)) {
...
ace.define("ace/mode/xml/dom", [], function(require, exports, module) {
    ...
    Element.prototype = {
        ...
        setAttribute: function setAttribute(name, value1) {
            var attr = this.ownerDocument.createAttribute(name);
            attr.value = attr.nodeValue = "" + value1;
        ...
        setAttributeNS: function setAttributeNS(namespaceURI, qualifiedName, value1) {
    ...
    function __set__(object, key, value1) {
        object[key] = value1;
    }
    ...
    try {
        if (Object.defineProperty) {
            ...
            __set__ = function __set__(object, key, value1) {
                object['$$' + key] = value1;
            };
        }
    } catch (e) {}
