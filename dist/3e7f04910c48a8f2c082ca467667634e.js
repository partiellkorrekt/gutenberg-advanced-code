...
ace.define("ace/ext/static_highlight", [
    ...
    var simpleDom = {
        createTextNode: function createTextNode(/** @type {string} */ textContent, /** @type {any} */ element) {
            return escapeHTML(textContent);
        },
        createElement: function createElement(/** @type {string} */ type) {
    ...
    var highlight = function highlight1(el, opts, callback) {
    ...
    highlight.render = function(input, mode, theme, lineStart, disableGutter, callback) {
        ...
        var modeOptions;
        if (mode && (typeof mode === "undefined" ? "undefined" : _type_of(mode)) === "object" && !mode.getTokenizer) {
            modeOptions = mode;
    ...
    module1.exports = highlight;
    module1.exports.highlight = highlight;
});
(function() {
    ace.require([
