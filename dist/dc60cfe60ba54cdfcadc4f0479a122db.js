...
ace.define("ace/ext/whitespace", [
    ...
    exports1.$detectIndentation = function(lines, fallback) {
        var stats = [];
        var changes = [];
        var tabIndents = 0;
        var prevSpaces = 0;
    ...
    exports1.detectIndentation = function(session) {
        var lines = session.getLines(0, 1000);
        var indent = exports1.$detectIndentation(lines) || {};
        if (indent.ch) session.setUseSoftTabs(indent.ch == " ");
        if (indent.length) session.setTabSize(indent.length);
        return indent;
    };
    exports1.trimTrailingSpace = function(session, options) {
    ...
    exports1.convertIndentation = function(session, ch, len) {
    ...
    exports1.$parseStringArg = function(text) {
        var indent = {};
    ...
    exports1.$parseArg = function(arg) {
        if (!arg) return {};
        if (typeof arg == "string") return exports1.$parseStringArg(arg);
        if (typeof arg.text == "string") return exports1.$parseStringArg(arg.text);
        return arg;
    };
    exports1.commands = [
        {
            ...
            exec: function exec(editor) {
                exports1.detectIndentation(editor.session);
            }
        },
        {
            ...
            exec: function exec(editor, args) {
                exports1.trimTrailingSpace(editor.session, args);
            }
        },
        {
            ...
            exec: function exec(editor, arg) {
                var indent = exports1.$parseArg(arg);
                exports1.convertIndentation(editor.session, indent.ch, indent.length);
            }
        },
        {
            name: "setIndentation",
