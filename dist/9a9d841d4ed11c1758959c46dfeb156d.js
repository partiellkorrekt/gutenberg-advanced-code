...
ace.define("ace/mode/astro_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    ...
    var HtmlHighlightRules = require("./html_highlight_rules").HtmlHighlightRules;
    var JavascriptHighlightRules = require("./javascript_highlight_rules").JavaScriptHighlightRules;
    var AstroHighlightRules = function AstroHighlightRules() {
        HtmlHighlightRules.call(this);
        var astro = {
            token: "paren.quasi.start",
            regex: /{/,
            next: function next(state, stack) {
                if (state !== "start") {
    ...
    exports1.AstroHighlightRules = AstroHighlightRules;
});
ace.define("ace/mode/behaviour/html", [
    ...
    exports1.HtmlBehaviour = HtmlBehaviour;
});
ace.define("ace/mode/astro", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
