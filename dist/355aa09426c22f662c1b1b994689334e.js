...
ace.define("ace/mode/css/csslint", [], function(require, exports, module) {
    var CSSLint = function() {
        var _$module = _$module || {}, exports = exports || {};
                    ...
                    function(require, module, exports) {
                        ...
                        Matcher.many = function(required) {
                            ...
                            var result = new Matcher(function(expression) {
                                ...
                                var tryMatch = function tryMatch1(matchCount) {
                                ...
                                _stylesheet: function _stylesheet() {
                                    ...
                                    while(tt > Tokens.EOF){
                                        try {
                                            ...
                                            if (_instanceof(ex, SyntaxError) && !this.options.strict) {
                                                this.fire({
                                                    type: "error",
                                                    error: ex,
                                                    message: ex.message,
                    ...
                    function(require, module, exports) {
                        ...
                        Specificity.calculate = function(selector) {
                            ...
                            for(i = 0, len = selector.parts.length; i < len; i++){
                                ...
                                if (_instanceof(part, SelectorPart)) {
                                    updateValues(part);
                                }
                            }
                    ...
                    function(require, module, exports) {
                        ...
                        (function() {
                            ...
                            for(var i = 0, len = Tokens.length; i < len; i++){
                                ...
                                if (Tokens[i].text) {
                                    if (_instanceof(Tokens[i].text, Array)) {
                    ...
                    function(require, module, exports) {
                        ...
                        copy(ValidationTypes, {
                            ...
                            describe: function describe(type) {
                                if (_instanceof(this.complex[type], Matcher)) {
                            ...
                            isType: function isType(expression, type) {
                                ...
                                } else if (_instanceof(this.complex[type], Matcher)) {
                    ...
                    function(require, module, exports) {
                        ...
                        StringReader.prototype = {
                            ...
                            readMatch: function readMatch(matcher) {
                                ...
                                } else if (_instanceof(matcher, RegExp)) {
                    ...
                    function(require, module, exports) {
                        ...
                        TokenStreamBase.prototype = {
                            ...
                            match: function match(tokenTypes, channel) {
                                if (!_instanceof(tokenTypes, Array)) {
                                    tokenTypes = [
                                        tokenTypes
                                    ];
                                }
        ...
        var clone = function() {
            'use strict';
            function _instanceof1(obj, type) {
                return type != null && _instanceof(obj, type);
            }
            var nativeMap;
            try {
                nativeMap = Map;
            ...
            function clone(parent, circular, depth, prototype, includeNonEnumerable) {
                if ((typeof circular === "undefined" ? "undefined" : _type_of(circular)) === 'object') {
                ...
                function _clone(parent, depth) {
                    ...
                    var child;
                    var proto;
                    if ((typeof parent === "undefined" ? "undefined" : _type_of(parent)) != 'object') {
                        return parent;
                    }
                    if (_instanceof1(parent, nativeMap)) {
                        child = new nativeMap();
                    } else if (_instanceof1(parent, nativeSet)) {
                        child = new nativeSet();
                    } else if (_instanceof1(parent, nativePromise)) {
                        ...
                        parent.copy(child);
                        return child;
                    } else if (_instanceof1(parent, Error)) {
                    ...
                    if (_instanceof1(parent, nativeSet)) {
            ...
            function __isDate(o) {
                return (typeof o === "undefined" ? "undefined" : _type_of(o)) === 'object' && __objToStr(o) === '[object Date]';
            }
            clone.__isDate = __isDate;
            function __isArray(o) {
                return (typeof o === "undefined" ? "undefined" : _type_of(o)) === 'object' && __objToStr(o) === '[object Array]';
            }
            clone.__isArray = __isArray;
            function __isRegExp(o) {
                return (typeof o === "undefined" ? "undefined" : _type_of(o)) === 'object' && __objToStr(o) === '[object RegExp]';
            }
        ...
        if ((typeof _$module === "undefined" ? "undefined" : _type_of(_$module)) === 'object' && _$module.exports) {
            _$module.exports = clone;
        }
        var CSSLint = function() {
            "use strict";
